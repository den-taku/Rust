...
fn main() {
    ...
    if args.len() != 5 {
        writeln!(std::io::stderr(),
                 "Usage: mandelbrot FILE PIXELS UPPERLEFT LOWERRRIGHT")
            .unwrap();
        writeln!(std::io::stderr(),
    ...
    // Scope fo slicing up `pixels` into horizontal bands.
    {
...
/// arguments specify points on the complexx plane corresponding to the upper-
