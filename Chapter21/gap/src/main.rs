...
mod gap {
    ...
    pub struct GapBuffer<T> {
        ...
        // Range of uninitialized elements in the middle of `strage`.
    ...
    impl<T> GapBuffer<T> {
        ...
        /// Return the currently insertion position.
        ...
        /// 
        /// Asfety: `index` must be a valid index into `self.storage`.
        ...
        /// and leave the insertion after it.
        ...
        /// and return if, or return `None` if the insertion position
...
fn main() {
    // println!("{}", type_of("Onion ".chars()));

    let mut buf = GapBuffer::new();
    buf.insert("Lord of the Rings".chars());
    buf.set_position(12);
